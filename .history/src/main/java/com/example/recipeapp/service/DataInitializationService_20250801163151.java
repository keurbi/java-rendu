...
public class DataInitializationService implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        System.out.println("");
        System.out.println("🔐 Pour tester l'application :");
        System.out.println("   Username: admin");
        System.out.println("   Password: admin123");
        System.out.println("   (Données d'exemple temporairement désactivées)");
        
        // L'initialisation sera réactivée une fois les problèmes de sérialisation résolus
        // initializeData();
    }
